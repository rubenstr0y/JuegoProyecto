...
public class PlayerObjectState:PlayerState
{
    ...
    {
        playerManager.playerController.player_wants_object = false;
    ...
    {
        if (!(playerManager.playerController.playerAnimator.GetCurrentAnimatorStateInfo(0).IsName("Object_Jump")))
        {
